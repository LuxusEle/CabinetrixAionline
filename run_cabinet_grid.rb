# =============================================================================
# Cabinex AI — Cabinet Comparison Grid (PRODUCTION REFERENCES, CANONICAL)
...
#   load "C:/Users/asank/Documents/CabinetrixAionline/run_cabinet_grid.rb"
...
module RunCabinetGrid
  ...
  REF = [
    "C:/Users/asank/Documents/CabinetrixAionline/gemini/demo_ljoint_connections.rb",
    "C:/Users/asank/Documents/CabinetrixAionline/gemini/gola_drawer_bank_master.rb",
    "C:/Users/asank/Documents/CabinetrixAionline/gemini/build_luxury_gola_kitchen_master.rb"
  ].freeze
  ...
  def self.build
    ...
    puts '>> CabinetGrid built from PRODUCTION references:'
...
unless defined?($CABINETGRID_NO_AUTORUN) && $CABINETGRID_NO_AUTORUN
